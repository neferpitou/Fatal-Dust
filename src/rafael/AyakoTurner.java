...
public class AyakoTurner // implements Character
{
	...
	// Image i =
	// Toolkit.getDefaultToolkit().getImage("resources/idle_left_0.gif");
	...
	public AyakoTurner(boolean lookingRight, int centerX) {
		...
		if (lookingRight) {
			greenHitBox = new Rectangle(centerX - 45, y + 50, 60, 150,
					Color.GREEN);
		}

		else {
			greenHitBox = new Rectangle(centerX - 15, y + 50, 60, 150,
					Color.GREEN);
		}
		...
		// a = new SpriteAnimated(topLeftX, topLeftY , W, H, lookingRight,
		// IMG_PREFIX);
